package mapony.city.b_precission;
 ...
 * 
 */
public class MaponyCityPrecissionJob extends Configured implements Tool {

	private static Properties properties;
	private static final Logger logger = LoggerFactory.getLogger(MaponyCityPrecissionJob.class);
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(MaponyCityPrecissionJob.class);
	...
	public static void main(String args[]) throws Exception {
		...
		ToolRunner.run(new MaponyCityPrecissionJob(), args);
		System.exit(1);
