package mapony.inferencia.b_precision;
...
import mapony.inferencia.b_precision.mapper.MaponyPrecisionMap;
 ...
 * 
 */
public class MaponyPrecisionJob extends Configured implements Tool {

	private static Properties properties;
	private static final Logger logger = LoggerFactory.getLogger(MaponyPrecisionJob.class);
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(MaponyPrecisionJob.class);
	...
	public static void main(String args[]) throws Exception {
		...
		ToolRunner.run(new MaponyPrecisionJob(), args);
		System.exit(1);
