 ...
 */
public class MaponyPrecisionMap extends Mapper<Text, RawDataArrayWritable, Text, RawDataWritable> {

	private static final Logger logger = LoggerFactory.getLogger(MaponyPrecisionMap.class);
